...
template <>
FilePath CategoryTreeItem<ComponentCategory>::getLatestCategory(const WorkspaceLibraryDb& lib) const throw (Exception)
{
    return lib.getLatestComponentCategory(mUuid);
}

template <>
FilePath CategoryTreeItem<PackageCategory>::getLatestCategory(const WorkspaceLibraryDb& lib) const throw (Exception)
{
    return lib.getLatestPackageCategory(mUuid);
}

template <>
QSet<Uuid> CategoryTreeItem<ComponentCategory>::getCategoryChilds(const WorkspaceLibraryDb& lib) const throw (Exception)
{
    return lib.getComponentCategoryChilds(mUuid);
}

template <>
QSet<Uuid> CategoryTreeItem<PackageCategory>::getCategoryChilds(const WorkspaceLibraryDb& lib) const throw (Exception)
{
