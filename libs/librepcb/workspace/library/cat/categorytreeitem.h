...
class CategoryTreeItem final
{
    ...
    private:
        ...
        // Methods
        FilePath getLatestCategory(const WorkspaceLibraryDb& lib) const throw (Exception);
        QSet<Uuid> getCategoryChilds(const WorkspaceLibraryDb& lib) const throw (Exception);
