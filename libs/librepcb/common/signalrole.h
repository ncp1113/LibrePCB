...
class SignalRole final
{
    ...
    public:
        ...
        /**
         * @brief Serialize the SignalRole to a string (e.g. to write it into an XML file)
         *
         * @return The generated string
         */
        const QString& toString() const noexcept {return mRole;}
        ...
        bool operator==(const SignalRole& rhs) noexcept {return mRole == rhs.mRole;}
        bool operator!=(const SignalRole& rhs) noexcept {return mRole != rhs.mRole;}
        ...
        /**
         * @brief Deserialize a SignalRole from a string
         *
         * @param str   The string (e.g. from an XML file)
         *
         * @return The SignalRole object of the given string
         *
         * @throw Exception if the given string is not a valid SignalRole
         */
        static const SignalRole& fromString(const QString& str) throw (Exception);
