...
void LineGraphicsItem::setLayer(const Layer* layer) noexcept
{
    if (mLayer) {
...
void LineGraphicsItem::layerColorChanged(const Layer& layer, const QColor& newColor) noexcept
{
    Q_UNUSED(layer);
...
void LineGraphicsItem::layerHighlightColorChanged(const Layer& layer, const QColor& newColor) noexcept
{
    Q_UNUSED(layer);
    Q_ASSERT(&layer == mLayer);
...
void LineGraphicsItem::layerFillStyleChanged(const Layer& layer, const Qt::BrushStyle& newStyle) noexcept
{
    Q_UNUSED(layer);
    Q_UNUSED(newStyle);
}

void LineGraphicsItem::layerVisibilityChanged(const Layer& layer, bool newVisible) noexcept
{
    Q_UNUSED(layer);
    Q_ASSERT(&layer == mLayer);
